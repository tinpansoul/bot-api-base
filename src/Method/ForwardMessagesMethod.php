...
/**
 * Class ForwardMessagesMethod.
 *
 * Use this method to forwardMessages messages of any kind. Album grouping is kept for copied messages.
 * On success, an array of MessageId of the sent messages is returned.
 *
 * @see https://core.telegram.org/bots/api#forwardMessages
 */
class ForwardMessagesMethod implements ForwardMethodAliasInterface
{
    ...
    /**
     * A list of 1-100 identifiers of messages in the chat fromChatId to forwardMessages.
